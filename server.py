...
def validate():
    ...
    #section above queries for any emails in the DB that match the email recently entered in the form on index.html. If statement then decides what to do next based on a few conditions..
